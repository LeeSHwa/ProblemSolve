...
<p><code>HR_DEPARTMENT</code>, <code>HR_EMPLOYEES</code>, <code>HR_GRADE</code> 테이블에서<web-highlight class="webhighlights-highlight" data-highlight-id="823b95af-4cb8-42bd-9697-1c9644f17a71" data-highlight-split-type="both" data-highlight-id-extra="" markid="6ab529866d0ff84c2cda3ea5" media-type="blockquote" style="background-color: rgb(248, 252, 70); color: rgb(0, 0, 0); cursor: pointer;"> 2022년도 한해 평가 점수가 가장 높은 사원 정보</web-highlight>를 조회하려 합니다. 2022년도 평가 점수가 가장 높은 사원들의 점수, 사번, 성명, 직책, 이메일을 조회하는 SQL문을 작성해주세요.</p>
