...
<p><code>CAR_RENTAL_COMPANY_CAR</code> 테이블에서 <web-highlight class="webhighlights-highlight" data-highlight-id="71a86855-729e-4e89-982f-e179a302002a" data-highlight-split-type="both" data-highlight-id-extra="" markid="6ab215e371cd20222cb83d2e" media-type="blockquote" style="background-color: rgb(248, 252, 70); cursor: pointer; color: rgb(0, 0, 0);">'통풍시트', '열선시트', '가죽시트' 중 하나 이상의 옵션이 포함</web-highlight>된 자동차가<web-highlight class="webhighlights-highlight" data-highlight-id="7312f6b5-9a07-455e-8e6b-fa5db1c2a70a" data-highlight-split-type="both" data-highlight-id-extra="" markid="6ab215e771cd20222cb83d31" media-type="blockquote" style="background-color: rgb(255, 173, 42); cursor: pointer; color: rgb(0, 0, 0);"> 자동차 종류 별로 몇 대</web-highlight>인지 출력하는 SQL문을 작성해주세요. 이때 자동차 수에 대한 컬럼명은 <code>CARS</code>로 지정하고, 결과는 자동차 종류를 기준으로 오름차순 정렬해주세요.</p>
